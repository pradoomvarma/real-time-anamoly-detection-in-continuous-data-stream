...
# Anomaly Detection Class using EWMA and Z-Score
class AnomalyDetector:
    def __init__(self, alpha=0.1, z_threshold=2):
        ...
        self.n = 0  # Number of processed points
    ...
    def detect(self, new_value):
        ...
        # Calculate Z-Score only if standard deviation is non-zero
...
def real_time_anomaly_detection(duration=60, interval=0.5, window_size=100):
    ...
    for i, data_point in enumerate(data_stream):
        ...
        # Add the data point to the deque and detect anomaly
